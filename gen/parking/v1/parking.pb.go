...
var file_parking_v1_parking_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_parking_v1_parking_proto_goTypes = []any{
	...
	(*Empty)(nil),                  // 4: parking.v1.Empty
}
var file_parking_v1_parking_proto_depIdxs = []int32{
	0, // 0: parking.v1.ParkingService.AssignSlot:input_type -> parking.v1.AssignSlotRequest
	2, // 1: parking.v1.ParkingService.ReleaseSlot:input_type -> parking.v1.ReleaseSlotRequest
	4, // 2: parking.v1.ParkingService.GetAvailableSlots:input_type -> parking.v1.Empty
	1, // 3: parking.v1.ParkingService.AssignSlot:output_type -> parking.v1.AssignSlotResponse
	4, // 4: parking.v1.ParkingService.ReleaseSlot:output_type -> parking.v1.Empty
	3, // 5: parking.v1.ParkingService.GetAvailableSlots:output_type -> parking.v1.AvailableSlotsResponse
